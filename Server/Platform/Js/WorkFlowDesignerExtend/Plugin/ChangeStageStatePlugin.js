//更改生命周期状态插件onCreate
InforCenter_Platform_ChangeStageStatePlugin_OnCreate = function (pageEvent) {
    ...
    if (currPlugin.Content) {
        try {
            ...
            if (content) {
                ...
                var data = HoteamUI.DataService.Call("InforCenter.Workflow.WorkflowTemplateExtendService.GetLifeCircleListforBindingDroupdown", { para: { StateType: "Stage", ModelName: content.ModelName } });
...
InforCenter_Platform_ChangeStageStatePlugin_ModelListOnChange = function (ctrlEvent) {
...
//更改生命周期状态插件onGetData
InforCenter_Platform_ChangeStageStatePlugin_OnGetData = function (pageEvent) {
    var page = pageEvent.o;
    var pagePara = page.GetPara();

    var plugin = {};
    plugin.Name = "ChangeStageState";
