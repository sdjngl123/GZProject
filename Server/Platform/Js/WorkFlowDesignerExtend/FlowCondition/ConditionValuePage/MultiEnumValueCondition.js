//对象授权结果加载页面
InforCenter_Platform_MultiEnumValueCondition_LoadPage = function (pageEvent) {
...
//获取页面保存数据
InforCenter_Platform_MultiEnumValueCondition_OnGetDataFromPage = function (pageEvent) {
