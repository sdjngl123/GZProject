//业务节点插件设置OnCreate
InforCenter_Platform_SelectedBusinessPluginSetting_OnCreate = function (pageEvent) {
    ...
    var pluginListCtrl = page.GetControl("SelectedBusinessPluginSettingAddpluginDropdown");
    var servicePara = {};
    servicePara.UseByType = "BusinessNode";
    ...
    var pagePara = {};
    pagePara.ShowType = "BusinessNode";
    pagePara.ParentPID = page.pid;

    var curPagePara = [];
    //初始化插件
    var layoutCtrl = page.GetControl("SelectedBusinessPluginSettingVLayout");
    ...
    HoteamUI.Page.SetContainerParas(page.pid, "SelectedBusinessPluginSetting", showPagePara);
}
//添加插件
InforCenter_Platform_SelectedBusinessPluginSetting_AddPlugin = function (ctrlEvent) {
    ...
    var ddlCtrl = ctrl.OtherControl("SelectedBusinessPluginSettingAddpluginDropdown");
    ...
    if (!para || !para.PageInfo || para.PageInfo.length == 0) {
        ...
        info.PageName = pageName;
        pageInfo.push(info);
        HoteamUI.Page.SetContainerParas(ctrl.ContainerID(), "SelectedBusinessPluginSetting", { PageInfo: pageInfo });
        var layoutCtrl = ctrl.OtherControl("SelectedBusinessPluginSettingVLayout");
        ...
        HoteamUI.Page.SetContainerParas(ctrl.ContainerID(), "SelectedBusinessPluginSetting", para);
        var size = {};
...
//业务节点插件设置OnCreate
InforCenter_Platform_SelectedBusinessPluginSetting_OnGetData = function (pageEvent) {
    var page = pageEvent.o;
...
//更改节点图片
InforCenter_Platform_SelectedImage_OnClick = function (ctrlEvent) {
    ...
    var callback = function (data, ret) {
        if (ret && ret.ReturnValue) {
            //19500 李金岳
            data.ctrl.SetSrc(ret.ReturnValue, ctrlEvent.o.isAutoZoom);
        }
    }
...
InforCenter_Platform_SelectedBusinessImage_OnClick = function (ctrlEvent) {
    var page = HoteamUI.Page.Instance(ctrlEvent.o.ContainerID());
    var pagePara = page.GetPara();
    ...
    pagePara.ObjectType = "WORKFLOWTEMPLATE";
    HoteamUI.UIManager.Popup("WorkflowSelectImage", pagePara, callback, { ctrl: ctrlEvent.o }, "520*280");
}

InforCenter_Platform_SelectedBusinessPluginSetting_OnCheck = function (pageEvent) {
    var page = pageEvent.o;
    var pagePara = page.GetPara();
    if (!pagePara || !pagePara.PageInfo) {
        return;
