...
EncryptDecrypt.long2str = function (v, w) {
    var vl = v.length;
    var n = (vl - 1) << 2;
    if (w) {
        var m = v[vl - 1];
...
EncryptDecrypt.str2long = function (s, w) {
    var len = s.length;
    var v = [];
...
EncryptDecrypt.Encrypt = function (str, key) {
    if (str == "") {
        return "";
    }
    ...
    return Base64.encode64(this.long2str(v, false));
}

EncryptDecrypt.Decrypt = function (str, key) {
    if (str == "") {
        return "";
    }
    ...
    return UtfParser.utf8to16(Base64.decode64(this.long2str(v, true)));
}
